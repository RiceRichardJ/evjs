...
export type Spob = {
	...
	xPos: number;
	yPos: number;
	type: number; // graphic num
	system: number; // wtf?
	techLevel: number;
	specialTech1: number; // TODO turn into array
	specialTech2: number;
	specialTech3: number;
	govt: number;
	minCoolness: number;
...
const spob: Record<number, Spob> = {
	...
	129: {
		...
		"xPos": -75,
		"yPos": -75,
		"type": 26, // omfg these point to SPIN 326 which points to PICT 2030 -- and the SPIN is exported wrong...
		"system": 129,
		"techLevel": 5,
		"specialTech1": -1,
		"specialTech2": -1,
